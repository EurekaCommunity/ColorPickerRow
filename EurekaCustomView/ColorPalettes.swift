...
struct Solarised {
    let palette = [ColorSpec(hex: "#002b36", name: "base03"),
...
struct WP8 {
    let palette = [ColorSpec(hex: "#A4C400", name: "lime"),
...
struct Flat {
    let palette = [ColorSpec(hex: "#1abc9c", name: "turquoise"),
...
struct Material {
    let palette = [ColorSpec(hex: "#f44336", name: "red"),
